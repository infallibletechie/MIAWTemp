      ...
      <div id="mainContainer">
        ...
        <script type='text/javascript'>
            ...
            function addRow(column1Data, column2Data) {
                ...
                cell2.innerHTML = JSON.stringify(column2Data, null, 2);
            }
	    ...
	    window.addEventListener("onEmbeddedMessagingWindowMinimized", (e) => {
            ...
            window.addEventListener("onEmbeddedMessagingButtonClicked", (e) => {
                ...
                addRow("onEmbeddedMessagingButtonClicked", JSON.stringify(e.detail));
            });
	    window.addEventListener("onEmbeddedMessagingConversationRouted", (e) => {
                ...
                addRow("onEmbeddedMessagingConversationRouted", JSON.stringify(e.detail));
            });
